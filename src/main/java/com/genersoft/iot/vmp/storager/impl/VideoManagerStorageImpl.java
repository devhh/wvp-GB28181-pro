...
public class VideoManagerStorageImpl implements IVideoManagerStorage {
	...
	@Override
	public List<DeviceChannel> queryChannelsByDeviceIdWithStartAndLimit(String deviceId,List<String> channelIds, String query, Boolean hasSubChannel, Boolean online, int start, int limit) {
