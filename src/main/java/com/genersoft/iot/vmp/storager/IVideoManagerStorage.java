...
public interface IVideoManagerStorage {
	...
	public List<DeviceChannel> queryChannelsByDeviceIdWithStartAndLimit(String deviceId,List<String> channels, String query, Boolean hasSubChannel, Boolean online, int start, int limit);
